...
pcc_gauge* pcc_new_gauge(const char *name, const char *desc, pcc_error *err);
...
pcc_gauge_vec* pcc_new_gauge_vec(const char *name, const char *desc, const char *labels[], pcc_error *err);
